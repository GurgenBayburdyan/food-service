...
public class CategoryFacadeImpl implements CategoryFacade {
    ...
    public List<CategoryDetailsDto> getAll() {
        ...
        log.info("Successfully executed get all categories rest API, response - {}", detailsDtos);
        return detailsDtos;
    }

    @Override
    public CategoryDetailsDto create(CreateCategoryRequestDto requestDto) {
        log.info("Executing create category for the provided request to - {}:", requestDto);
        ...
        if (optionalErrorType.isPresent()) {
            ...
            log.info("Executing create category failed, error-{}", optionalErrorType.get());
            return detailsDto;
        }
        ...
        log.info("Successfully executed create category rest API, response - {}", detailsDto);
        return detailsDto;
    }
}
